...
const Header = () => {
  ...
  const navItems = [
    ...
    { label: "Chỉnh sửa trang bio", path: "/bio-edit" },
      ...
      <div className="flex items-center justify-between w-full">
        ...
        {userData === null ? (
          ...
          <div className=" w-[18%] flex items-center justify-between">
            <Button
              className="hidden md:flex w-[70%] h-12 text-base px-8 rounded-3xl bg-gradient-to-r from-[#16C875] to-[#6CDFAB] justify-center items-center font-bold text-white"
              onClick={() => {
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48 bg-white">
                ...
                <DropdownMenuItem
                  className="font-helvetica text-base hover:bg-green-100"
                  onSelect={() => navigate("/my-collection")}
                >
                  Bộ sưu tập
                </DropdownMenuItem>
                <DropdownMenuItem
        ...
        <div className="md:hidden flex items-center">
          <Sheet>
            ...
            <SheetContent side="right" className="w-64 p-6 bg-white">
              ...
              {/* ✅ Thêm phần này: check user đăng nhập trong hamburger menu */}
              {userData === null ? (
                <div className="flex flex-col gap-3">
                  <Button
                    className="bg-gradient-to-r from-[#16C875] to-[#6CDFAB] text-white font-bold w-full"
                    onClick={() => navigate("/login")}
                  >
                    Đăng nhập
                  </Button>
                  <Button
                    className="bg-white text-black border border-black font-bold w-full"
                    onClick={() => navigate("/create-account")}
                  >
                    Đăng ký
                  </Button>
