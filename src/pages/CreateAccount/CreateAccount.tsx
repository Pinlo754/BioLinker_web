					...
					<div className="flex-[1] w-full min-w-[500px] max-w-xl bg-white rounded-3xl shadow-xl p-8 md:p-10 ">
						<form className="space-y-6">
							<div className="text-center space-y-2">
								<h2 className="text-3xl md:text-4xl font-semibold tracking-tight text-gray-900">Tạo tài khoản</h2>
								<p className="text-gray-600 text-base">
									Đã có tài khoản? <Link to="/login" className="font-medium text-gray-900 underline">Đăng nhập</Link>
								</p>
							</div>

								<div className="space-y-3 items-center justify-center">
								    <div className="w-[90%] mx-auto" ref={buttonsRef}>
								        <button type="button" className="w-full inline-flex items-center justify-center gap-3 rounded-full border border-gray-300 bg-white px-5 py-1 text-gray-800 hover:bg-gray-50 transition">
								        	...
								        	<span className="text-sm md:text-base">Tiếp tục với Facebook</span>
								        </button>
							...
							<div className="space-y-2">
								<p className="text-center text-xl text-gray-600">Nhập địa chỉ email của bạn để tạo tài khoản.</p>
								<label className="block text-lg text-gray-700">Email của bạn</label>
								<input type="email" placeholder="name@example.com" 
                                        ...
                                        value={email}
                                />
                                {validEmail === false && validSubmit ? <span className=" ml-4 mt-6 text-red-500 text-base">Vui lòng nhập địa chỉ email hợp lệ</span > : ""}
							</div>
