...
const Market = () => {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col">
      <Header />
      <main className="flex-1 w-full max-w-[1440px] mx-auto py-8 px-6 flex gap-8">
        {/* Sidebar filter */}
        <AsideBar />
        {/* Main content */}
        <section className="flex-1">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div className="flex items-center gap-2">
              <button className="lg:hidden bg-white rounded-full px-4 py-2 shadow">Filters</button>
              <input
                type="text"
                placeholder="Search"
                className="border border-gray-300 rounded-full px-4 py-2 w-64 focus:outline-none focus:ring-2 focus:ring-green-300"
              />
            </div>
            <div>
