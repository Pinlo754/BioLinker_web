            ...
            <div className="flex items-center space-x-0 gap-4">
              ...
              <div className="flex-1">
                <input
                  ...
                  className={`flex-1 w-full bg-white border rounded-full px-4 py-2 text-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green1 focus:border-green1 ${
